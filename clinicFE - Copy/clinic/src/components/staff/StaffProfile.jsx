...
const StaffProfile = ({ staff }) => {
  ...
  const fetchStaffProfile = async () => {
    try {
      const response = await fetch(`http://localhost:3000/api/staff/${staff.staffId}`);
      if (response.ok) {
        ...
        setProfileData({
          ...
          emergencyContactPhone1: staffData.emergencyContactPhone1 || '',
          emergencyContactPhone2: staffData.emergencyContactPhone2 || '',
  ...
  const handleSaveProfile = async () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        const updatedStaff = { ...staff, ...profileData };
  ...
  const handleCancelEdit = () => {
    ...
    setErrors({});
    setMessage('');
    fetchStaffProfile(); // Reset to original data
  };
    ...
    <div className="staff-profile-container">
      <div className="staff-profile-header">
        ...
        <div className="staff-profile-title">
          <h1>Staff Account Settings</h1>
          <p>Update your staff account information accordingly.</p>
        </div>
      </div>
        ...
        <div className="staff-profile-section">
          ...
          <div className="staff-profile-form">
            <div className="form-row">
              ...
              <div className="form-group">
                <label>In Case of Emergency Relationship to Staff</label>
                {isEditing ? (
                  <input
                    type="text"
